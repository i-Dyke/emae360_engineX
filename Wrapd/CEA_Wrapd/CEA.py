...
#// I don't even technically know python
#// I just added the UVProblem function
#//  to extend the existing code.
#// (plus some additions to make it work
#//   within the rest of the existing code)
#// All my comments are in this form of "#//"
#// Have fun!
...
class Problem:
  ...
  def __init__(self, *,
               ...
               #// Added to allow for UV. 
               #// Will be ignored for all existing implementations
               #// Just as pressure input is ignored for UV
  ...
  def set_density(self, density: float): self.density = density
  ...
  def set_density_units(self, density_units: str):
    ...
    choices = ["kg","g"]
    if density_units not in choices:
      raise ValueError("density unit must be in " + ", ".join(choices))
