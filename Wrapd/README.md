# Welcome to CEA_Wrapd
an Extension of ...

# CEA_Wrap
*A Python-Based wrapper for the NASA CEA Thermochemical Code*

... produced by Ian Dyke @ CWRU. Full origin to all of the functional parts of this program goes to the original CEA_Wrap creator (civilwargeeky @ github).

I don't really understand git implementations and pip, but I've gotten far on 

**pip install -e <directoryOfCEA_Wrapd>**

Throw a ! before pip if you're using Jupyter.

Good luck, have fun.

### *All below this line are from the original CEA_Wrap implementation.* 
